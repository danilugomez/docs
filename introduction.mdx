...
<CardGroup cols={2}>
  <Card title="Get started" icon="code" href="https://docs.vibess.ai/quickstart">
    Connect your stripe account, and integrate Vibes with your platform
  </Card>
  <Card title="Set up your first flow" icon="file-waveform" href="https://mintlify.com/docs/development">
...
<CardGroup cols={2}>
  ...
  <Card title="Get Inspiration" icon="stars" href="https://mintlify.com/customers">
    Check out our showcase of our favorite documentatio/
  </Card>
</CardGroup>