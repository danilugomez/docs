...
div style="position: relative; padding-bottom: calc(62.5% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/7dhEJxxTdggKTlsf1KjT?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true" title="How to setup your Stripe account" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div>
